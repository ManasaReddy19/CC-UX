...
gulp.task('inject-js-css', function () {
    ...
    var sources = gulp.src(['./js/*.module.js', './js/*.js', './js/configs/*.config.js', './js/controllers/*.controller.js', './js/services/*.service.js'], {read: false});
...
gulp.task('watch', function () {
    watch(['./js/*.*.js', './js/**/*.*.js', './sass/*.s+(a|c)ss'], batch(function (events, done) {
